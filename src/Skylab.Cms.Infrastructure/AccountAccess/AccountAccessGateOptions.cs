...
public sealed class AccountAccessGateOptions
{
    ...
    public static AccountAccessGateOptions FromConfiguration(
        ...
        IHostEnvironment hostEnvironment)
    {
        ...
        if (!string.Equals(authority, AccountAccessGateContract.ExactIssuer, StringComparison.Ordinal))
        {
            throw new InvalidOperationException(
                $"Keycloak:Authority must be exactly '{AccountAccessGateContract.ExactIssuer}' when ACCOUNT_ACCESS_GATE_MODE=enforce.");
        }
        ...
        if (hostEnvironment.IsProduction() && !useTls)
        {
            throw new InvalidOperationException(
    ...
    internal ConfigurationOptions ToRedisConfiguration()
    {
        ...
        var options = new ConfigurationOptions
        {
            ...
            ClientName = "cms-account-access-gate",
